            ...
            <div class="card-body p-0">
                <div class="row">
                    <div class="col-12 col-md-6 col-lg-6">
                        <form class="" action="{{ route('petugas.transaksi.store') }}" method="POST">
                            @csrf
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="date" class="form-control daterange-cus  @error('tgl_bayar') is-invalid @enderror" name="tgl_bayar" value="{{ old('tgl_bayar') }}">
                                        @error('tgl_bayar')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="form-group">
                                    <label>Bulan</label>
                                    <select class="form-control  @error('bulan_bayar') is-invalid @enderror" name="bulan_bayar">
                                        <option value=" ">--Pilih Bulan--</option>
                                        @foreach ($bulan as $item)
                                        <option value="{{ $item }}" {{ (old('bulan_bayar') === $item) ? 'selected' : '' }}>{{ $item }}</option>
                                        @endforeach
                                    </select>
                                     @error('bulan_bayar')
                                        <div class="invalid-feedback">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <select class="form-control   @error('spp_id') is-invalid @enderror" name="spp_id">
                                        ...
                                        <option id="rupiah" value="{{ $item->id }}" {{ (old('spp_id') == $item->id) ? 'selected' : '' }}>Tahun {{ $item->tahun }} | nominal
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('jumlah_bayar') is-invalid @enderror" placeholder="Enter Jumlah Bayar"

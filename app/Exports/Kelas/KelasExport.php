...
class KelasExport implements FromQuery, WithHeadings, WithMapping, WithCustomStartCell, WithStyles, WithColumnWidths, ShouldAutoSize, WithTitle
{
    use Exportable;
    private $getdata;
    ...
    public function styles(Worksheet $sheet)
    {
        ...
        $sheet->mergeCells('B4:D4')->setCellValue('B4', 'Data Kelas');

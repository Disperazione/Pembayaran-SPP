...
class SppExport implements FromQuery, WithHeadings, WithMapping, WithCustomStartCell, WithStyles, WithColumnWidths, ShouldAutoSize, WithTitle
{
    use Exportable;
    private $getdata;
    ...
    public function map($spp): array
    {
        return [
            '',
            $spp->tahun,
            'Rp. ' . number_format($spp->nominal, 2, ',', '.')
        ];
    }
